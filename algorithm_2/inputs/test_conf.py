...
config ={
    'test_settings':{# 测试设置 
        ...
        'visualize':False,				# 是否进行可视化(建议关闭 开启可视化会大幅降低测试效率) ,True表示开启,False表示关闭
        'save_fig_whitout_show':True,	# 当'visualize'为 True,and 'visualize_save_png'为 True,代码运行并保存至默认目录下
